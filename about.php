		...
		<!--banner-section-->
            ...
            <div class="top-news">
                <div class="about-content">
                    ...
                    <img src="http://localhost/placement/includes/logo.png" alt="image here">
                    <p>
                        <label>We are the students from Imcc college Pune Studying MCA FY and this is our college project in which we the tem of three were working together to buid this project.</label></p>
                    <div class="clearfix"></div>
                    <p class="nam">Dummy text --Nam libero tempore, cum soluta nobis est eligendi
                ...
                <div class="edit-pics">
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a target="_blank" href="https://shubhammali.tech">Shubham Mali MCA FY</a></h5>
                    ...
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="">Pratik Masalkar MCA FY</a></h5>
                            <div class="td-post-date two"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="">Hitesh Mohadikar MCA FY</a></h5>
                            <div class="td-post-date two"> </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
